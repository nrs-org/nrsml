...
function acceptImpact(scope: Scope, impact: Impact) {
    if(!("DAH_obj_location" in impact.DAH_meta)) {
        impact.DAH_meta.DAH_obj_location = Object.assign({}, scope.document.config.DAH_obj_location);
    }
...
function processRelationBase<S extends string>(
    ...
    for (const relation of relations) {
        ...
        if(!("DAH_obj_location" in relation.DAH_meta)) {
            relation.DAH_meta.DAH_obj_location = Object.assign({}, scope.document.config.DAH_obj_location);
        }
